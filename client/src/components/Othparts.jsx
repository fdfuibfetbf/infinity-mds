 ...
 const [part, setPart] = useState([]);
  ...
  useEffect(() => {
    const fetchParts = async () => {
      try {
        const res = await fetch(`http://infinity-yn0b-qet3.onrender.com/get?modality=${modality}`);
...
<img className="w-full h-55 pt-2 object-contain bg-white" src={`http://infinity-yn0b-qet3.onrender.com${v.image}`}
 alt={v.p} />
